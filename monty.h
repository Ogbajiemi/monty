...
void push_new(stack_t **head, unsigned int number);
void _pall(stack_t **head, unsigned int number);
void pint_new(stack_t **head, unsigned int number);
int myexec(char *content, stack_t **head, unsigned int counter, FILE *file);
void free_stack(stack_t *head);
void pop_mi(stack_t **head, unsigned int counter);
void swap(stack_t **head, unsigned int counter);
void addin(stack_t **head, unsigned int counter);
void _5nop(stack_t **head, unsigned int counter);
...
void stackie(stack_t **head, unsigned int counter);
